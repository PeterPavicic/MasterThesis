...
datasummary_df(blockwise_PM_cause_ZQ_table_trace, output = "latex", align = "lccccl", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_PM_cause_ZQ_table_eigen, output = "latex", align = "lccccl", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_ZQ_cause_PM_table_trace, output = "latex", align = "lccccl", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_ZQ_cause_PM_table_eigen, output = "latex", align = "lccccl", title = "WRITE CAPTION HERE")
...
datasummary_df(blockwise_PM_cause_ZQ_table_trace, output = "latex", align = "lllll", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_PM_cause_ZQ_table_eigen, output = "latex", align = "lllll", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_ZQ_cause_PM_table_trace, output = "latex", align = "lllll", title = "WRITE CAPTION HERE")
datasummary_df(blockwise_ZQ_cause_PM_table_eigen, output = "latex", align = "lllll", title = "WRITE CAPTION HERE")
